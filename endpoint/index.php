<?php
    ...
    // Fetch timestamp
    $last_updated = file_get_contents($config->updated_file);
    // Last update within 2 minutes?
    $status = (strtotime($last_updated) > strtotime($config->timespan) ? 'online' : 'offline');
?>
    ...
    <head>
        ...
        <title>
            <?php if($status == 'online'):?>
                Yeah &#128077;, Andrea is online!
            <?php else: ?>
                No &#128078;, Andrea is offline!
            <?php endif; ?>
        </title>
        ...
        <meta content="Is Andrea Online?" property="og:title" />
        <meta content="website" property="og:type" />
        <meta content="Don't know if Andrea is online? Find out here" property="og:description" />
        <meta content="http://isandrea.online" property="og:url" />
        <meta content="/preview-image.png" property="og:image" />

        <meta content="summary_large_image" name="twitter:card" />
        <meta content="Is Andrea Online?" name="twitter:title" />
        <meta content="Don't know if Andrea is online? Find out here" name="twitter:description" />
        <meta content="/preview-image.png" name="twitter:image" />
        <meta content="http://isandrea.online" name="twitter:url" />
        ...
        <style>
            ...
            body.Andrea--is-online{
                background-color:#dff0d8;
            }
            body.Andrea--is-offline{
